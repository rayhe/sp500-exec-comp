...
(function() {
    var METHODOLOGY_CONTENT = {
        ...
        dataq: {
            ...
            html: '<h4>Primary Source: SEC DEF 14A</h4>' +
                ...
                '<li><strong>rounding</strong> — Components don\'t foot the printed total by a small gap; values stored verbatim from the filing. 304 <em>verified</em> rows carry $1&ndash;$2 deltas — that is the filer\'s own rounded-dollar arithmetic, not a parse error, so they stay verified by taxonomy decision (2026-09-10).</li>' +
                ...
                '</ol>' +
                '<div id="dataq-coverage-block"><h4>Coverage (last audit 2026-09-18)</h4>' +
                '<p>6,835 of 6,863 NEO rows verified (99.6%): 0 rounding, 0 recomputed, 28 component_mismatch — the remaining rows are honestly labeled, not silently dropped.</p></div>' +
                '<div id="dataq-payratio-block"><h4>Pay ratio methodology</h4>' +
                '<p id="dataq-payratio-counts">As of the 2026-09-18 screen: 384 of 500 screened companies\' disclosed ratios match <code>total_compensation / median_worker_pay</code> within 3% tolerance; 15 cluster near 2x, 10 near 0.5x, 91 differ otherwise.</p>' +
    ...
    function _dataqCoverageHtml() {
        ...
        return '<h4>Coverage (last audit ' + (dq.last_audit || '2026-09-18') + ')</h4>' +
