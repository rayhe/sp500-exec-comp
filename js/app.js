    ...
    var METHODOLOGY_CONTENT = {
        ...
        dataq: {
            ...
            html: '<h4>Primary Source: SEC DEF 14A</h4>' +
                ...
                '<p id="dataq-payratio-counts">As of the 2026-09-16 screen: 355 of 499 screened companies\' disclosed ratios match <code>total_compensation / median_worker_pay</code> within 3% tolerance; 24 cluster near 2x, 10 near 0.5x, 110 differ otherwise. (TSLA excluded: no disclosed ratio.)</p>' +
