...
(function() {
    var METHODOLOGY_CONTENT = {
        ...
        dataq: {
            ...
            html: '<h4>Primary Source: SEC DEF 14A</h4>' +
                ...
                '<p>6,759 of 6,780 NEO rows verified (99.7%): 0 rounding, 0 recomputed, 21 component_mismatch — the remaining rows are honestly labeled, not silently dropped.</p></div>' +
    ...
    function _dataqTitleArtifactsHtml() {
        ...
        return 'Live screen: ' + rows + ' NEO row' + (rows === 1 ? '' : 's') + ' at ' + nCos +
               ' compan' + (nCos === 1 ? 'y' : 'ies') +
               ' still carry title artifacts; the 79 repaired since the 2026-09-14 screen are documented in the breakdown above.';
    }
