    ...
    var METHODOLOGY_CONTENT = {
        ...
        dataq: {
            ...
            html: '<h4>Primary Source: SEC DEF 14A</h4>' +
                ...
                '<li><strong>rounding</strong> — Components don\'t foot the printed total by a small gap; values stored verbatim from the filing. 307 <em>verified</em> rows carry $1&ndash;$2 deltas — that is the filer\'s own rounded-dollar arithmetic, not a parse error, so they stay verified by taxonomy decision (2026-09-10).</li>' +
                ...
                '<p>6,798 of 6,819 NEO rows verified (99.7%): 0 rounding, 0 recomputed, 21 component_mismatch — the remaining rows are honestly labeled, not silently dropped.</p></div>' +
