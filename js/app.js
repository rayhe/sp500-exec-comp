    ...
    var METHODOLOGY_CONTENT = {
        ...
        dataq: {
            ...
            html: '<h4>Primary Source: SEC DEF 14A</h4>' +
                ...
                '<li><strong>rounding</strong> — Components don\'t foot the printed total by a small gap; values stored verbatim from the filing. 275 <em>verified</em> rows carry $1&ndash;$2 deltas — that is the filer\'s own rounded-dollar arithmetic, not a parse error, so they stay verified by taxonomy decision (2026-09-10).</li>' +
                ...
                '<p id="dataq-payratio-counts">As of the 2026-09-16 screen: 359 of 499 screened companies\' disclosed ratios match <code>total_compensation / median_worker_pay</code> within 3% tolerance; 23 cluster near 2x, 10 near 0.5x, 107 differ otherwise. (TSLA excluded: no disclosed ratio.)</p>' +
