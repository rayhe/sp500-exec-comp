    ...
    var METHODOLOGY_CONTENT = {
        ...
        dataq: {
            ...
            html: '<h4>Primary Source: SEC DEF 14A</h4>' +
                ...
                '<p>6,762 of 6,782 NEO rows verified (99.7%): 0 rounding, 0 recomputed, 20 component_mismatch — the remaining rows are honestly labeled, not silently dropped.</p></div>' +
