...
(function() {
    ...
    function _dataqTitleArtifactsHtml() {
        ...
        return 'Live screen: ' + rows + ' NEO rows at ' + Object.keys(tickers).length +
               ' companies still carry title artifacts; the 33 repaired since the 2026-09-14 screen are documented in the breakdown above.';
    }
