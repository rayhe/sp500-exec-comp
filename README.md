...
Every NEO row in `data/compensation.json` carries a `_total_source` label describing its audit state, assigned against the primary DEF 14A Summary Compensation Table. Buckets (as of the 2026-09-10 audit: 6,781 rows):

| Label | Meaning | Rows |
|---|---|---|
| `verified` | Components and total match the filing SCT verbatim. Includes `def14a_verified_YYYYMMDD` re-verification passes | 6,718 (99.1%) |
